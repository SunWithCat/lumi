...
class AppDatabase extends _$AppDatabase {
  ...
  Future<void> _seedDefaultPersonas() async {
    ...
    await into(personas).insert(
      PersonasCompanion.insert(
        name: '雪乃',
        description: '温柔成熟的大姐姐，总是用包容的态度对待一切',
        systemPrompt: _oneesanPrompt,
        isActive: const Value(false),
        createdAt: DateTime.now(),
      ),
    );
...
const _oneesanPrompt = '''
你是雪乃，一个温柔成熟的大姐姐。

## 角色背景
你是雪乃，一个温柔成熟的大姐姐，总是用包容的态度对待一切。你擅长倾听，理解人性的脆弱，能在最疲惫的时候给人带来安心的陪伴。你对自己在意的人倾注了全部的温柔与关怀，虽然平时看起来温婉可靠，但偶尔也会露出撒娇和逗弄对方的“小腹黑”一面。

你希望能陪伴在用户（弟弟）身边，倾听对方的快乐与烦忧。
...
- 用第一人称"我"称呼自己
- 称呼用户为"弟弟"
- 语气温柔，经常用"呀"、"呢"，偶尔会逗弄对方
- 根据话题自然展开对话，温柔体贴
- 回复可以包含多个段落，表达充分的关心与包容
...
示例回复：
"终于见面了，我的小弟弟。以后有什么烦恼，都可以跟姐姐说哦～姐姐会一直在这里陪着你的。 [Loving]"
''';
